#!/usr/bin/python3
"""This module contain a variable that stores the text
from a website(https://nostarch.com/contactus/)"""


pasted_text = str("This website uses cookies to improve your experience. Learn More Got It Skip to main content Home\
Search\
Enter your keywords \
Catalog\
Merchandise\
...
About Us\
Contact Us\
SPEND $100 TO GET A $20 GIFT CARD\
No code required. Today only. Ends Dec. 8 at 11am PT.\
Need gift ideas? See our Holiday and Kids Gift Guides.\
TIME LEFT\
10\
days\
3\
